...
const RightCardContet = (props) => {
  return (
    <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
      ...
      <div>
        <p className='text-lg text-white mb-10 leading-relaxed'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et, expedita iste voluptatibus laborum dolor atque?</p>
